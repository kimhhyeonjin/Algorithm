...
- 함수
  ...
  - sort
    ...
    - 원본을 변경하여 정렬
      ...
      - [LV2 / 가장 큰 수](./프로그래머스/2/42746. 가장 큰 수/가장 큰 수.py)

      - [LV1 / ［PCCE 기출문제］ 10번 ／ 데이터 분석](./프로그래머스/1/250121. ［PCCE 기출문제］ 10번 ／ 데이터 분석/［PCCE 기출문제］ 10번 ／ 데이터 분석.py)
...
- [LV2 / 땅따먹기](./프로그래머스/2/12913. 땅따먹기/땅따먹기.py)

- [LV3 / 등굣길](./프로그래머스/3/42898. 등굣길/등굣길.py)
...
- [LV2 / 주식가격](./프로그래머스/2/42584. 주식가격/주식가격.py)

- [LV2 / 택배상자](./프로그래머스/2/131704. 택배상자/택배상자.py)
